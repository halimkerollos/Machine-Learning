...
# Disclaimer: all customer information is fake,
# and purely for pracice and display of data analysis,
# visualization, and implemenation of machine learning.
...
#
# For the rest of the exercise we'll only be using the
# numerical data of the csv file.
# ___
...
# **Let's explore these types of relationships across
# the entire data set.

# **Based off this plot what looks to be the most
# correlated feature with Yearly Amount Spent?**

# Definitely Membership Length seems to be the most correlated with
# Yearly Amount Spent.
...
#
# Now that we've explored the data a bit, let's go ahead
# and split the data into training and testing sets.
# ** Set a variable X equal to the numerical
...
# ** Use model_selection.train_test_split from
...
# A pretty darn good line,
# great prediction on the part of the machine learning model.

# ## Evaluating the Model
#
# Let's evaluate our model performance
# by calculating the residual sum of squares and the
...
# Explained Variance Score, above,
# describes the percentage of data that our model
# accurately predicts and in this case its just about 99%,
# which is pretty excellent.

# ## Residuals
#
# You should have gotten a very good model with a good fit.
# Let's quickly explore the residuals to make sure everything was okay
# with our data.
#
# **Plot a histogram of the residuals and make sure
...
# From what it looks like we have the highest coefficient
# when it comes to Length of Membership,
# combined with the information from the pairplots above,
# I would say that is where the company should focus most of its efforts.
# Beyond that it appears that Time on App is the next greatest
# coefficient so they can also put their efforts into leveraging the
# app and it's features in order to maximize profits from the platform
# that is the most popular.

# Well if they want a well balanced usage,
# the website is suffering tremendously,
# so either completely redo that or just focus more on the app
# which seems to be far more popular and appears to generate
# much more income than the website.
# My recommendation:
